...
A little bit of history: Data General was founded in 1968 by four founders, three of whom were former employees of Digital Equipment Corporation (DEC), the company famous for minicomputers like the PDP-8. DEC had expressed no interest in moving from 12-bit to 16-bit architectures at the time, so the three engineers left to start Data General and build the new design themselves. They went through years of commercial success for their 16-bit machines, then later developed the 32-bit Eclipse: the intense development of the Eclipse MV/8000 became the inspiration for the Pulitzer Prize-winning Tracy Kidder book, *The Soul of a New Machine*. They also helped define the future of portable laptop computers with the Data General/One in 1984.
